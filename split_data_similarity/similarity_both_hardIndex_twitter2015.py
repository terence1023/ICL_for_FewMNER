...
pd_test = pd.read_csv("./image_caption_ofa/twitter2015_process_caption_test.csv", sep='\t')
pd_train = pd.read_csv("./split_data_similarity/split_dataset/twitter2015/{}/train-{}.csv".format(dataset, dataset), sep='\t')
...
def cal_features(pd_data, model, processor):
    ...
    for i in tqdm(range(length)):
        root_image = "/data10T/caichenran/2023/MICL/dataset/mner/twitter2015_images/"
...
root_path = "./split_data_similarity/result/twitter2015/{}/".format(dataset)
if not os.path.exists(root_path):
    os.makedirs(root_path)
test_target_path = root_path + "twitter2015_{}_process_caption_similar_image_text_hardindex_test.csv".format(dataset)
