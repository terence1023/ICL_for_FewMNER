...
root_path = "split_data_similarity/result/twitter2015/"
test_file = "twitter2015_{}_process_caption_similar_image_text_hardindex_test.csv".format(dataset)
...
for i in tqdm(range(last_run, len(pd_test))):
    ...
    try:
        ...
        chat_predict.loc[i, "text"] = my_sentence
        pass
    chat_predict.to_csv("multiMM_gpt3.5_twitter2015_50-1_shot-4_predict_test.csv", sep='\t', index=False)